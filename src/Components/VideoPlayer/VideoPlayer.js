...
function VideoPlayer () {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        axios
            .get(`https://www.googleapis.com/youtube/v3/videos?part=snippet%2C%20statistics&id=${videoId}&key=AIzaSyCiTDSX9v0gKl6O1OHII1wrtj5tXPNZwEU`)
            .then(response => {
    ...
    async function createVideoInfo(video) {
        ...
        const response = await axios
            .get(`https://www.googleapis.com/youtube/v3/channels?part=snippet%2C%20statistics&id=${channelId}&key=AIzaSyCiTDSX9v0gKl6O1OHII1wrtj5tXPNZwEU`)
